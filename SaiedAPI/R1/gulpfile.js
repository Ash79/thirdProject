...
if (awsConfig.accessKeyId && awsConfig.accessKeyId != '' && awsConfig.accessKeyId != "AKIAJ4KXAOL2JYJAWTJA") {
...
gulp.task('upload-s3-client', function() {
    return gulp.src(['./aws/**', '!./aws/template.json', '!./aws/config.json', '!./aws/parameters.json'])
        .pipe(gulpS3Upload({
